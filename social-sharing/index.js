...
var SocialSharing = (function (_super) {
    ...
    SocialSharing.prototype.shareViaTwitterWithPasteMessageHint = function (message, image, url, pasteMessageHint,imageBack) {
        return;
    };
    /**
     ...
     * @param imageBack {string}
     * @returns {Promise<any>}
     */
    SocialSharing.prototype.shareViaFacebookWithPasteMessageHint = function (message, image, url, pasteMessageHint,imageBack) {
        return;
    };
    /**
     * Shares directly to Instagram
    ...
    __decorate([
        ...
        __metadata("design:paramtypes", [String, String, String]),
        __metadata("design:returntype", Promise)
    ],SocialSharing.prototype, "shareViaTwitterWithPasteMessageHint", null);
    __decorate([
        Cordova({
            platforms: ['iOS', 'Android']
        }),
