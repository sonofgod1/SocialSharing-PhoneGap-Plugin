...
export declare class SocialSharing extends IonicNativePlugin {
    ...
    shareViaTwitter(message: string, image?: string, url?: string): Promise<any>;
        /**
     * Shares directly to Twitter with a paste message hint
     * @param message {string}
     * @param image {string}
     * @param url {string}
     ...
     * @returns {Promise<any>}
     */
    shareViaTwitterWithPasteMessageHint(message: string, image?: string, url?: string, pasteMessageHint?: string,imageBack?:string): Promise<any>;
    /**
     ...
     * @returns {Promise<any>}
     */
    shareViaFacebookWithPasteMessageHint(message: string, image?: string, url?: string, pasteMessageHint?: string,imageBack?:string): Promise<any>;
    /**
     * Shares directly to Facebook with a paste message hint
     * @param message {string}
     * @param image {string}
