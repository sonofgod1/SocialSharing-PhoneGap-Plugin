...
Es el mismo de EddyVerbruggen, gracias por su trabajo, solo se agregó la misma funcionalidad de pegar un texto desde el portapapeles para Twitter en IOS, no está implementado para las demas plataformas. 
...
```
$ phonegap local plugin add https://github.com/sonofgod1/SocialSharing-PhoneGap-Plugin.git
```

or with Cordova CLI, from npm:
```
$ cordova plugin add https://github.com/sonofgod1/SocialSharing-PhoneGap-Plugin.git
$ cordova prepare
```
